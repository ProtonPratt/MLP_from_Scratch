...
class MLP:
    ...
    def __init__(self, input_size, hidden_layers, output_size, epochs = 100, learning_rate = 0.01, early_stopping = False,
                 ...
                 Random_state = None, weight_init = 'he', model_type = 'class_ML'):
...
mlp = MLP(11, [10, 10], 6, epochs = 1000, learning_rate = 0.1, batch_size = 16, activation_function = 'relu', early_stopping=True,
          loss_function = 'cross_entropy', optimizer = 'mini_batch', beta = 0.0, Random_state=4, model_type='class_ML')
